...
| 表名 | 所属 | 说明 | 与本模块关系 |
|------|------|------|------------|
| `ai_user_profile` | {项目名} | 用户画像主表 | **核心主表** |
| `ai_chat_user_relation` | {项目名} | 渠道绑定关联表 | ONE ID 合并时迁移渠道关联 |
| `ai_audit_log` | {项目名} | 审计日志表 | 画像变更、ONE ID 合并写入审计 |
